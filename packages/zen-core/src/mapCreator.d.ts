...
type MapInitializer<T extends object, ID = string, Args extends any[] = any[]> = (store: MapAtom<T>, id: ID, ...args: Args) => void;
type StoreInstanceCreator<T extends object, ID = string, Args extends any[] = any[]> = (id: ID, ...args: Args) => MapAtom<T>;
/**
 ...
 */
export declare function mapCreator<T extends object, ID = string, Args extends any[] = any[]>(initializer: MapInitializer<T, ID, Args>): StoreInstanceCreator<T, ID, Args>;
export {};
