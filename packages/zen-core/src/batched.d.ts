...
export declare function batched<T, S1 extends AnyAtom>(store1: S1, calculation: (value1: AtomValue<S1>) => T): BatchedAtom<T>;
export declare function batched<T, Stores extends AnyAtom[]>(stores: [...Stores], calculation: (...values: {
