...
export declare function onStart<A extends AnyAtom>(
  a: A,
  fn: LifecycleListener<AtomValue<A>>,
): Unsubscribe;
/** Attaches a listener triggered when the last subscriber disappears. */
export declare function onStop<A extends AnyAtom>(
  a: A,
  fn: LifecycleListener<AtomValue<A>>,
): Unsubscribe;
...
export declare function onNotify<A extends AnyAtom>(
  a: A,
  fn: LifecycleListener<AtomValue<A>>,
): Unsubscribe;
/** Attaches a listener triggered immediately and only once upon attachment. */
export declare function onMount<A extends AnyAtom>(
  a: A,
  fn: LifecycleListener<AtomValue<A>>,
): Unsubscribe;
/**
 ...
 */
export declare function listenPaths<A extends MapAtom<any> | DeepMapAtom<any>>(
  // Add MapAtom back
  a: A,
  paths: Path[],
  fn: PathListener<AtomValue<A>>,
): Unsubscribe;
/**
 ...
 * @internal
 */
export declare function _emitPathChanges<A extends MapAtom<any> | DeepMapAtom<any>>(
  // Add MapAtom back
  a: A,
  changedPaths: Path[],
  finalValue: AtomValue<A>,
): void;
/**
 * Listens to changes for specific keys within a map atom.
 * Relies on the internal atom having the `STORE_MAP_KEY_SET` symbol.
 */
export declare function listenKeys<
  A extends MapAtom<any> | DeepMapAtom<any>,
  K extends keyof AtomValue<A>,
>(
  // Add MapAtom back
  a: A,
  keys: K[],
  fn: KeyListener<AtomValue<A>, K>,
): Unsubscribe;
/**
 ...
 * @internal
 */
export declare function _emitKeyChanges<A extends MapAtom<any> | DeepMapAtom<any>>(
  // Add MapAtom back
  a: A,
