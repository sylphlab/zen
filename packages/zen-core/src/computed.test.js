...
import { get as getAtomValue, set as setAtomValue, subscribe as subscribeToAtom, zen, } from './atom'; // Import updated functional API
...
describe('computed (functional)', () => {
    ...
    it('should handle multiple dependencies', () => {
        ...
        const sum = computed(
        // biome-ignore lint/suspicious/noExplicitAny: Test setup requires cast
        [num1, num2], (n1, n2) => n1 + n2); // Use computed, accept unknown, cast inside
        const listener = vi.fn();
        // biome-ignore lint/suspicious/noExplicitAny: Test setup requires cast
    ...
    it('should unsubscribe from dependencies when last listener unsubscribes', () => {
        ...
        // biome-ignore lint/suspicious/noExplicitAny: Test setup requires cast
        [dep1, dep2], (d1, d2) => d1 + d2); // Use computed, accept unknown, cast inside
        const listener = vi.fn();
