...
import { map, MapAtom, Unsubscribe, get, subscribe } from '@sylphlab/zen-core';
import { $router, RouterState } from '@sylphlab/zen-router'; // Import real $router
...
describe('useRouter', () => {
    ...
    beforeEach(() => {
        ...
        mockGet.mockImplementation((store: MapAtom<RouterState>) => {
        ...
        mockSubscribe.mockImplementation((store: MapAtom<RouterState>, listener: (state: RouterState) => void): Unsubscribe => {
